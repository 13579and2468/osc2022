...
struct file_operations fat32_file_operations = {fat32_write, fat32_read, fat32_open, fat32_close, vfs_lseek64, fat32_getsize};
...
int fat32_lookup(struct vnode *dir_node, struct vnode **target, const char *component_name)
{
    ...
    uart_printf("fat32 lookup not found\r\n");
    return -1;
}
...
int fat32_create(struct vnode *dir_node, struct vnode **target, const char *component_name)
{
    ...
    if (inode->type != dir_t)
    {
        uart_printf("fat32 create not dir_t\r\n");
        return -1;
    }
    ...
    for (; child_idx < MAX_DIR_ENTRY; child_idx++)
    {
        ...
        {
            uart_printf("fat32 create file exists\r\n");
            return -1;
        }
    }
...
int fat32_mkdir(struct vnode *dir_node, struct vnode **target, const char *component_name)
{
    ...
    if (inode->type != dir_t)
    {
        uart_printf("fat32 mkdir not dir_t\r\n");
        return -1;
    }
